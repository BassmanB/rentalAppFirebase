...
public class Home extends AppCompatActivity
    ...
    private void loadMenu() {
        FirebaseRecyclerAdapter<Category, com.example.rentalapp.ViewHolder.MenuViewHolder> adapter = new FirebaseRecyclerAdapter<Category, com.example.rentalapp.ViewHolder.MenuViewHolder>(Category.class, R.layout.menu_item, com.example.rentalapp.ViewHolder.MenuViewHolder.class, category) {
            @Override
